        ...
        <div class="col-sm-8" style="background-color: rgb(255, 255, 255);">
            ...
            <table class="table table-hover" style="background-color: rgb(255, 255, 255);">
                ...
                <tbody>
                    ...
                    <%
                        ArrayList<Order> pendingList = OrderBL.getPendingOrders();
                        for (Order o : pendingList)
                          {
                            ...
                            out.println("<td><form action=\"finalize_proc\" method=\"POST\">");
                            out.println("<input type=\"hidden\" id=\"orderID\" name=\"orderID\" value=" + o.getOrderID() + " >");
                            out.println("<input type=\"submit\" value= \"Finalize Order\">");
                            out.println("</form></td");
                            out.println(" </tr>");
